...
class ClientTrackingReader(avango.script.Script):
...
class ClientTrackingTargetReader(ClientTrackingReader):
  ...
  ## Default constructor.
  def __init__(self):
    self.super(ClientTrackingReader).__init__()
...
class ClientTrackingDefaultReader(ClientTrackingReader):
